...
public class MaintainCheckActivity extends BaseActivity {

	// 条码扫描返回码
	private final static int SCANNIN_GREQUEST_CODE = 1;
	private final static int ACCEPT_REQUEST_CODE = 2;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		page = 0;
		isLoading = false;
		listMaintainPlans = maintainPlanDao.findByPage(page,getDepCode(),4);
		page = page + 30;
		adapter = new MyListAdapter(MaintainCheckActivity.this,
		...
		listViewMaintainPlan.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(MaintainCheckActivity.this,
						MaintainCheckAcceptActivity.class);
				intent.putExtra("interType", "accept");
				...
				startActivityForResult(intent,ACCEPT_REQUEST_CODE);
	...
	private void initSearchBar() {
		...
		buttonScan.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(MaintainCheckActivity.this,
		...
		imageClear.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				isLoading = false;
				listMaintainPlans.clear();
				listMaintainPlans.addAll(maintainPlanDao.findByPage(page,getDepCode(),4));
				page = page + 30;
				adapter.notifyDataSetChanged();
			}
	...
	private class MyListAdapter extends ArrayAdapter<MaintainTaskBean> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			String isChecked = b.getIschecked();
			...
			item_lineName.setText(checkText);
